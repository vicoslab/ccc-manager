...
def add_user(k, df):
        ...
        index = None
        if st.session_state['mentor_view'] in st.session_state.mentors:
            index = st.session_state.mentors.index(st.session_state['mentor_view'])
        mentor = st.selectbox('Mentor', st.session_state.mentors, index, accept_new_options = True)
